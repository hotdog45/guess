...
export const constantRouterMap = [
  ...
  { path: '/ordersettlement', component: asyncImport('Shares/OrderSettlement')},
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  { path: '/loginIn/login/:path?', component: asyncImport('loginIn/Login'), hidden: true },
  { path: '/loginIn/regist/:path?', component: asyncImport('loginIn/regist'), hidden: true },
  { path: '/loginIn/rule', component: asyncImport('loginIn/rule'), hidden: true },
