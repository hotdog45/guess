      ...
      if (browser.versions.weixin) {
        ...
        window.setTimeout(() => {
          ...
          if (timeOutDateTime - loadDateTime < 5000) {
            window.location.href = 'https://itunes.apple.com/cn/app/id1219779989';
          } else {
            window.close();
          }
        },
        25);
        window.location.href = 'DFCUser://';
      } else if (browser.versions.android) {
        window.location = 'buyer://com.dfcapp.dfcbugers';
        window.setTimeout(() => {
          window.location.href = 'https://shop.dfcshop.com/mobile/rd.html#buyer';
        }, 3000);
        window.location.href = 'dfcbuyers://dfcbuyers';
      }
    },
  },
};
